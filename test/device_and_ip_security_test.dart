...
void main() {
  ...
  group('Device & IP Security Unit Tests', () {
    ...
    test(
      'getDeviceId generates and persists a valid unique deviceId',
      () async {
    ...
    test(
      'IP limit logic correctly allows up to 3 distinct IPs and blocks 4th',
      () {
    ...
    test('Single active device session mismatch detection', () {
      ...
      expect(
        serverDeviceIdNew != localDeviceId,
        isTrue,
      ); // Triggers kick-out on Device A!
    });
  });
}
