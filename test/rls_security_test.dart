...
void main() {
  group('Profile System & Security Baseline Tests', () {
    test('Default user registration yields student role and non-vip status', () {
    ...
    test('UserModel.fromMap safely parses profiles table columns with defaults', () {
      final rawProfile = {
        'id': 'uuid-student-2',
    ...
    test('Client-forged admin role payload is prevented in safe deserialization', () {
  ...
  group('RLS Error Mapping & Exception Handling Tests', () {
    test('Translates permission denied / RLS violation into clear Kurdish message', () {
