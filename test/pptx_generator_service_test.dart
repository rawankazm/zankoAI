...
void main() {
  ...
  group('PptxGeneratorService Tests', () {
    test('getSlideSpecificImageUrl matches AI category for LLM topics', () {
      ...
      final imgUrlSlide1 = PptxGeneratorService.getSlideSpecificImageUrl(
        topic,
        1,
      );
      final imgUrlSlide2 = PptxGeneratorService.getSlideSpecificImageUrl(
        topic,
        2,
      );
    ...
    test(
      'createPptxBytes produces valid OpenXML PPTX with full-bleed cover and content slides',
      () async {
        ...
        // Hero image and cover elements
        expect(slide1Xml, contains('HeroImage'));
        ...
        expect(slide1Xml, contains('name="UnivBadge"'));
    ...
    test(
      'getSlideSpecificImageUrl correctly categorizes all diverse academic departments',
      () {
        // Dentistry
