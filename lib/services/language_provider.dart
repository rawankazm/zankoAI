...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'teacher_analytics_title': {'ku': 'ئامارەکانی قوتابیان', 'ar': 'تحليلات الطلاب', 'en': 'Student Analytics'},
    'teacher_lectures_title': {'ku': 'بارکردنی وانەکان', 'ar': 'رفع المحاضرات', 'en': 'Upload Lectures'},
    'teacher_announcements_title': {'ku': 'ئاگادارییەکان', 'ar': 'الإعلانات', 'en': 'Announcements'},
    'teacher_quizzes_exams_title': {'ku': 'کویز و تاقیکردنەوەکان', 'ar': 'الاختبارات والامتحانات', 'en': 'Quizzes & Exams'},
    'upload_lecture': {'ku': 'بارکردنی وانەی نوێ', 'ar': 'رفع محاضرة جديدة', 'en': 'Upload New Lecture'},
    'lecture_title': {'ku': 'ناوی وانە', 'ar': 'عنوان المحاضرة', 'en': 'Lecture Title'},
    'lecture_type': {'ku': 'جۆری وانە', 'ar': 'نوع المحاضرة', 'en': 'Lecture Type'},
    'pdf_format': {'ku': 'فایلی PDF', 'ar': 'ملف PDF', 'en': 'PDF Document'},
    'ppt_format': {'ku': 'پڕیزێنتەیشن PPT', 'ar': 'عرض تقديمي PPT', 'en': 'PPT Presentation'},
    'video_format': {'ku': 'ڤیدیۆ', 'ar': 'فيديو', 'en': 'Video Lesson'},
    'file_url_or_name': {'ku': 'لینک یان ناوی فایل', 'ar': 'رابط أو اسم الملف', 'en': 'File Link / Path'},
    'send_announcement': {'ku': 'ناردنی ئاگاداری', 'ar': 'إرسال إعلان', 'en': 'Send Announcement'},
    'announcement_title': {'ku': 'سەردێڕی ئاگاداری', 'ar': 'عنوان الإعلان', 'en': 'Announcement Title'},
    'announcement_content': {'ku': 'ناوەڕۆکی ئاگاداری', 'ar': 'محتوى الإعلان', 'en': 'Announcement Content'},
    'priority_normal': {'ku': 'ئاسایی', 'ar': 'عادي', 'en': 'Normal'},
    'priority_important': {'ku': 'گرنگ', 'ar': 'مهم', 'en': 'Important'},
    'priority_urgent': {'ku': 'بەپەلە', 'ar': 'عاجل', 'en': 'Urgent'},
    'create_exam': {'ku': 'دروستکردنی تاقیکردنەوە (Exam)', 'ar': 'إنشاء امتحان formal', 'en': 'Create Timed Exam'},
    'passing_score': {'ku': 'نمرەی دەرچوون (%)', 'ar': 'درجة النجاح (%)', 'en': 'Passing Score (%)'},
    'duration_minutes': {'ku': 'ماوە (بە خولەک)', 'ar': 'المدة (بالدقائق)', 'en': 'Duration (Minutes)'},
    'grade_distribution': {'ku': 'دابەشبوونی نمرەکان', 'ar': 'توزيع الدرجات', 'en': 'Grade Distribution'},
    'top_performers': {'ku': 'قوتابییە باڵاکان', 'ar': 'الطلاب المتفوقين', 'en': 'Top Performers'},
    'at_risk_students': {'ku': 'قوتابییانی پێویست بە هاوکاری', 'ar': 'الطلاب المحتاجين للمساعدة', 'en': 'At-Risk Students'},
    'send_feedback': {'ku': 'ناردنی فێدباک بۆ قوتابی', 'ar': 'إرسال ملاحظات للطالب', 'en': 'Send Student Feedback'},
    'student_analytics': {'ku': 'ئاماری گشتی قوتابیان', 'ar': 'تحليلات الطلاب العامة', 'en': 'Overall Student Analytics'},
    'teacher_stats_lectures': {'ku': 'وانە بارکراوەکان', 'ar': 'المحاضرات المرفوعة', 'en': 'Lectures Uploaded'},
    'teacher_stats_announcements': {'ku': 'ئاگادارییەکان', 'ar': 'الإعلانات', 'en': 'Announcements'},
  };
}
