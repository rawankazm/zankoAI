...
class AcademicDictionaryData {
  static final List<AcademicTerm> allTerms = [
    // =========================================================================
    // 🩺 MEDICINE (پزیشکی) - 100 TERMS
    // =========================================================================
    AcademicTerm(
      term: 'Hypertrophy',
      kuName: 'گەورەبوونی شانە / هایپەرتڕۆفی',
      category: 'پزیشکی 🩺',
      kuDesc: 'زیادبوونی قەبارەی ئەندام یان شانەیەک بەهۆی گەورەبوونی قەبارەی خولگەکان (خانییەکان) نەک ژمارەیان.',
    ...
    AcademicTerm(
      ...
      kuName: 'پاسۆفیزۆلۆجی / زانستی نیشانەی نەخۆشی',
      category: 'پزیشکی 🩺',
      kuDesc: 'خوێندنی گۆڕانکارییە فسیۆلۆجییە ناڕێکەکان کە لە ئەنجامی نەخۆشییەکانەوە دروست دەبن.',
      enDesc: 'The study of disordered physiological processes that cause, result from, or are associated with disease.',
      example: 'Understanding pathophysiology helps in targeted drug design.',
    ),
    AcademicTerm(
      term: 'Homeostasis',
      kuName: 'هاوسەنگیی ناوەکی / هۆمیۆستاسیس',
      category: 'پزیشکی 🩺',
      kuDesc: 'توانای جەستە بۆ پاراستنی هاوسەنگی و جێگیریی ژینگەی ناوەوە لە کاتی گۆڕانکارییە دەرەکییەکاندا.',
      enDesc: 'State of steady internal physical and chemical conditions maintained by living systems.',
      example: 'Body temperature regulation is a vital homeostasis mechanism.',
    ),
    AcademicTerm(
      term: 'Necrosis',
      kuName: 'مردنی شانەکان / نێکرۆسس',
      category: 'پزیشکی 🩺',
      kuDesc: 'مردنی نەخوازراوی خانی و شانەکان لە جەستەدا لە ئەنجامی برینداربوون، ژەهراویبوون یان کەمی خوێن.',
    ...
    AcademicTerm(
      term: 'Apoptosis',
      kuName: 'مردنی خۆویستی خانی / ئەپۆپتۆزس',
      category: 'پزیشکی 🩺',
      kuDesc: 'پرۆسەی مردنی بەرنامەرێژکراوی خانییەکان کە جەستە بۆ لەناوبردنی خانییە کۆن یان زیانپێکەوتووەکان بەکاریدێنێت.',
    ...
    AcademicTerm(
      term: 'Hematopoiesis',
      kuName: 'دروستبوونی خانییەکانی خوێن',
      category: 'پزیشکی 🩺',
      kuDesc: 'پرۆسەی دروستبوون و پێگەیشتنی هەموو جۆرەکانی خانیی خوێن لە مۆخی ئێسکدا.',
      enDesc: 'The formation of blood cellular components in the bone marrow.',
      example: 'Erythropoietin stimulates hematopoiesis in response to low oxygen.',
    ),
    AcademicTerm(
      term: 'Idiopathic',
      kuName: 'نادیارەهۆکار / ئیدیۆپاسیک',
      category: 'پزیشکی 🩺',
      kuDesc: 'بەکارستێت بۆ هەر نەخۆشی یان حاڵەتێک کە هۆکاری پەیدابوونی لەڕووی پزیشکییەوە نادیارە.',
      enDesc: 'Denoting any disease or condition which arises spontaneously or for which the cause is unknown.',
      example: 'Idiopathic pulmonary fibrosis has no clearly identified etiology.',
    ),
    AcademicTerm(
      term: 'Etiology',
      kuName: 'زانستی هۆکاری نەخۆشی / ئیتێۆلۆجی',
      category: 'پزیشکی 🩺',
      kuDesc: 'خوێندنی هۆکار یان سەرچاوەی نەخۆشییەکان و فاکتەرە تووشکەرەکان.',
      enDesc: 'The cause, set of causes, or manner of causation of a disease or condition.',
      example: 'Bacterial infection is the primary etiology of streptococcal pharyngitis.',
    ),
    AcademicTerm(
      term: 'Prognosis',
      kuName: 'پێشبینی ڕەوتی نەخۆشی / پرۆگنۆزس',
      category: 'پزیشکی 🩺',
      kuDesc: 'پێشبینیکردنی ئەگەری چاکبوونەوە یان ڕەوتی بەرەوپێشچوونی نەخۆشییەک لە پاش دیاریکردنی.',
      enDesc: 'The likely course or outcome of a medical condition.',
      example: 'Early detection improves cancer prognosis significantly.',
    ),
    AcademicTerm(
      term: 'Tachycardia',
      kuName: 'خێراپێدانی لێدانی دڵ / تاکیکاردیا',
      category: 'پزیشکی 🩺',
      kuDesc: 'حاڵەتێک کە تێیدا لێدانی دڵ لە ئاستی ئاسایی خێراتر دەبێت (زیاتر لە ۱۰۰ لێدان لە خولەکێکدا بۆ کەسی پێگەیشتوو).',
      enDesc: 'Heart rate that exceeds the normal resting rate, usually over 100 beats per minute.',
      example: 'Sinus tachycardia can occur during intense exercise or panic attacks.',
    ),
    AcademicTerm(
      term: 'Bradycardia',
      kuName: 'هێواشبوونی لێدانی دڵ / برادیکاردیا',
      category: 'پزیشکی 🩺',
      kuDesc: 'کەمبوونەوەی لێدانی دڵ لە ئاستی ئاسایی (کەمتر لە ٦٠ لێدان لە خولەکێکدا لە کاتی حەوانەوەدا).',
      enDesc: 'Abnormally slow heart action, typically under 60 beats per minute.',
      example: 'Athlete bradycardia is common due to high cardiac efficiency.',
    ),
    AcademicTerm(
      term: 'Hypoxia',
      kuName: 'کەمی ئۆکسیجینی شانەکان / هایپۆکسیا',
      category: 'پزیشکی 🩺',
      kuDesc: 'کەمبوونەوەی ڕێژەی ئۆکسیجینی پێویست لە شانەکاندا بۆ بەڕێوەبردنی بەها فسیۆلۆجییەکان.',
      enDesc: 'Condition in which the body or a region of the body is deprived of adequate oxygen supply at the tissue level.',
      example: 'High altitude sickness is driven by arterial hypoxia.',
    ),
    AcademicTerm(
      term: 'Cyanosis',
      kuName: 'شینبوونەوەی پێست / سیانۆسس',
      category: 'پزیشکی 🩺',
      kuDesc: 'ڕەنگی شین یان مۆر هەڵگەڕانی پێست و پەردە شلەمەنییەکان بەهۆی کەمی ئۆکسیجین لە خوێندا.',
      enDesc: 'Bluish discoloration of the skin resulting from poor circulation or inadequate oxygenation of the blood.',
      example: 'Peripheral cyanosis can occur in severe cold exposure.',
    ),
    AcademicTerm(
