...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (errStr.contains('ip-limit-exceeded') ||
        ...
        _errorMessage =
            '⛔ ناتوانیت لە زیاتر لە ٣ ناونیشانی IP جیاواز ئەکاونتەکەت بکەیتەوە.\nئەمە بۆ پاراستنی ئەکاونت و ڕێگرییە لە هاوبەشکردنی نایاسایی.';
        ...
        _errorMessage =
            'تکایە سەرەتا ئیمەیڵەکەت لە ناو ئیمەیڵەکەتەوە پشتڕاست بکەرەوە، یاخود لە پەنێڵی Supabase بژاردەی Confirm Email بکوژێنەرەوە.';
        ...
        _errorMessage =
            'پڕۆسەکە سەرکەوتوو نەبوو: ${e.toString().replaceAll('Exception: ', '').replaceAll('AuthException: ', '').replaceAll('AuthApiException: ', '')}';
      }
    } finally {
      if (mounted && !success) {
        setState(() {
          _isLoading = false;
          _errorMessage ??=
              'پڕۆسەکە سەرکەوتوو نەبوو. تکایە زانیارییەکان بپشکنە.';
        });
      }
    }
  ...
  Future<void> _loginWithGoogle() async {
    ...
    try {
      ...
      success = false;
      _errorMessage =
          'چوونەژوورەوە بە گووگڵ کاتی بەسەرچوو. تکایە هێڵی ئینتەرنێتەکەت بپشکنە.';
    } catch (e) {
      success = false;
      _errorMessage =
          'هەڵە لە چوونەژوورەوە بە گووگڵ: ${e.toString().replaceAll('Exception: ', '')}';
    } finally {
      if (mounted && !success) {
        setState(() {
          _isLoading = false;
  ...
  Future<void> _loginWithApple() async {
    ...
    try {
      ...
      success = false;
      _errorMessage =
          'چوونەژوورەوە بە ئەپڵ کاتی بەسەرچوو. تکایە هێڵی ئینتەرنێتەکەت بپشکنە.';
    } catch (e) {
      success = false;
      _errorMessage =
          'هەڵە لە چوونەژوورەوە بە ئەپڵ: ${e.toString().replaceAll('Exception: ', '')}';
    } finally {
      if (mounted && !success) {
        setState(() {
          _isLoading = false;
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'نموونە: هێڵی ئینتەرنێتم گۆڕیوە، تکایە ڕێگەم پێبدەن...',
                              ...
                              try {
                                ...
                                if (mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        '✅ داواکارییەکەت بۆ ئەدمین نێردرا. دوای پێداچوونەوە دەتوانیت بچیتە ژوورەوە.',
                                      ),
                                ...
                                if (mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        '❌ ناردن سەرکەوتوو نەبوو: ${e.toString()}',
                                      ),
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                if (_errorMessage!.contains('IP') ||
                                    _errorMessage!.contains('ئایپی')) ...[
